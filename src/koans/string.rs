...
fn string_literals() {
    ...
    assert_eq!(string_slice, "Hello World");
}
...
fn string_to_slice() {
    ...
    assert_eq!(slice, "Can't stop me now");
}
...
fn using_chars() {
    ...
    assert_eq!(string.chars().nth(2), "y".chars().nth(0));
}
